...
Pretty much the same idea behind the vortex scripts but it shows petpets in the turmac screen, I should make it so the data is cache'd instead of pulled everytime but i dont care enough. Future improvements could be showing the petpet's names ala grave danger?
...
### [DEPRECATED AND GAY] Show Birthday Wheel Ad Button:
